...
DEFAULT_CONFIG = {
    "host_usernames": ["aryan_0990_"],
    "admin_usernames": ["aryan_0990_"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6946bffc94977936f7937068")
    api_token = os.getenv("API_TOKEN", "6ab03bbeb4720b3a39b895f7")
    
    if not room_id or not api_token:
        logger.error("ROOM_ID  API_TOKEN  ")
        return
